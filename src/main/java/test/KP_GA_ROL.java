...
public class KP_GA_ROL {
    ...
    public KP_GA_ROL(int s, int l, int d, int g, float c, float m, float h) {
        scale = s;
        LL = l;
        dimension = d;
        MAX_GEN = g;
    ...
    public KP_GA_ROL(int s, IntegerTestCase tc, int g, float c, float m, float h, String test_case_name) {
        scale = s;
        LL = tc.LL;
    ...
    public KP_GA_ROL(int s, IntegerTestCase tc, int g, float c, float m, float h,
    ...
    public static void main(String[] args) throws IOException {
        ...
        int[] local_times_list = {10, 20, 50, 70, 100};
        ...
        for (f_id = 0; f_id < file_path_list.length; f_id++) {
            ...
            //int mutate_arg = 1;
            //int select_arg = 2;
            //if (file_path_arg.equals("testcases/chubeas/OR30x250/OR30x250-0.25_1.dat")) {
            //    scale_arg = 80;
            //    Pc_arg = 0.99f;
            //    Pm_arg = 0.001f;
            //    cross_arg = 5;
            ...
            int select_arg = 5;
            float Ph_arg = 0.6f;
            for (exp_count = 0; exp_count < local_times_list.length; exp_count++) {
                int local_times_arg = local_times_list[exp_count];
                ...
                boolean success;
                for (int i = 0; i < 50; i++) {
                    KP_GA_ROL ga = new KP_GA_ROL(scale_arg, tc, 5000, Pc_arg, Pm_arg, Ph_arg,
