...
public class KP_IGA_scale {
    ...
    public KP_IGA_scale(int s, int l, int d, int g, float c, float m, float h) {
        scale = s;
        LL = l;
        dimension = d;
        MAX_GEN = g;
    ...
    public KP_IGA_scale(int s, IntegerTestCase tc, int g, float c, float m, float h, String test_case_name) {
        scale = s;
        LL = tc.LL;
    ...
    public KP_IGA_scale(int s, IntegerTestCase tc, int g, float c, float m, float h,
    ...
    public static void main(String[] args) throws IOException {
        ...
        int[] scale_list = {120, 140, 160, 180, 200};
        ...
        for (f_id = 0; f_id < file_path_list.length; f_id++) {
            ...
            int select_arg = 5;
            float Ph_arg = 0.6f;
            int local_times_arg = 70;
            for (exp_count = 0; exp_count < scale_list.length; exp_count++) {
                int scale_arg = scale_list[exp_count];
                ...
                boolean success;
                for (int i = 0; i < 50; i++) {
                    KP_IGA_scale ga = new KP_IGA_scale(scale_arg, tc, 5000, Pc_arg, Pm_arg, Ph_arg,
