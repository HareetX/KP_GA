...
public class KP_GA_RO {
    ...
    public KP_GA_RO(int s, int l, int d, int g, float c, float m, float h) {
        scale = s;
        LL = l;
        dimension = d;
        MAX_GEN = g;
    ...
    public KP_GA_RO(int s, IntegerTestCase tc, int g, float c, float m, float h, String test_case_name) {
        scale = s;
        LL = tc.LL;
    ...
    public KP_GA_RO(int s, IntegerTestCase tc, int g, float c, float m, float h,
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (f_id = 0; f_id < file_path_list.length; f_id++) {
            ...
            for (exp_count = 0; exp_count < Ph_list.length; exp_count++) {
                ...
                boolean success;
                for (int i = 0; i < 50; i++) {
                    KP_GA_RO ga = new KP_GA_RO(scale_arg, tc, 5000, Pc_arg, Pm_arg, Ph_arg,
