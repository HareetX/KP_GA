...
public class KP_IGA_Pc {
    ...
    public KP_IGA_Pc(int s, int l, int d, int g, float c, float m, float h) {
        scale = s;
        LL = l;
        dimension = d;
        MAX_GEN = g;
    ...
    public KP_IGA_Pc(int s, IntegerTestCase tc, int g, float c, float m, float h, String test_case_name) {
        scale = s;
        LL = tc.LL;
    ...
    public KP_IGA_Pc(int s, IntegerTestCase tc, int g, float c, float m, float h,
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (f_id = 0; f_id < file_path_list.length; f_id++) {
            ...
            for (exp_count = 0; exp_count < Pc_list.length; exp_count++) {
                float Pc_arg = Pc_list[exp_count];
                ...
                boolean success;
                for (int i = 0; i < 50; i++) {
                    KP_IGA_Pc ga = new KP_IGA_Pc(scale_arg, tc, 5000, Pc_arg, Pm_arg, Ph_arg,
