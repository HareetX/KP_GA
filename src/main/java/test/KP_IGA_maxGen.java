...
public class KP_IGA_maxGen {
    ...
    public KP_IGA_maxGen(int s, int l, int d, int g, float c, float m, float h) {
        scale = s;
        LL = l;
        dimension = d;
        MAX_GEN = g;
    ...
    public KP_IGA_maxGen(int s, IntegerTestCase tc, int g, float c, float m, float h, String test_case_name) {
        scale = s;
        LL = tc.LL;
    ...
    public KP_IGA_maxGen(int s, IntegerTestCase tc, int g, float c, float m, float h,
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (f_id = 0; f_id < file_path_list.length; f_id++) {
            ...
            boolean success;
            for (int i = 0; i < 10; i++) {
                KP_IGA_maxGen ga = new KP_IGA_maxGen(scale_arg, tc, 10000, Pc_arg, Pm_arg, Ph_arg,
