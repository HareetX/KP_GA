...
public class KP_IGA_Test {
    ...
    public KP_IGA_Test(int s, int l, int d, int g, float c, float m, float h) {
        scale = s;
        LL = l;
        dimension = d;
        MAX_GEN = g;
    ...
    public KP_IGA_Test(int s, IntegerTestCase tc, int g, float c, float m, float h, String test_case_name) {
        scale = s;
        LL = tc.LL;
    ...
    public KP_IGA_Test(int s, IntegerTestCase tc, int g, float c, float m, float h,
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (f_id = 0; f_id < file_path_list.length; f_id++) {
            ...
            for (int exp_id = 0; exp_id < 3; exp_id++) {
                if (exp_id == 0) {
                    // IGA
                    int scale_arg = 100;
                    float Pc_arg = 0.99f;
                    ...
                    boolean success;
                    for (int i = 0; i < 50; i++) {
                        KP_IGA_Test ga = new KP_IGA_Test(scale_arg, tc, 5000, Pc_arg, Pm_arg, Ph_arg,
